...
This folder defines all source code for the 'medallion_etl' pipeline:
...
* Take a look at the sample under "sample_users_medallion_etl.py" to get familiar with the syntax.
